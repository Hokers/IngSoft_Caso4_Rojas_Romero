...
%%%%%%% CASO-1 %%%%%%%%%%%%%%%%
\newpage
\input{cap/casosUso/Caso1.tex}

%%%%%%% CASO-2 %%%%%%%%%%%%%%%%
\newpage
\input{cap/casosUso/Caso2.tex}

%%%%%%% CASO-3 %%%%%%%%%%%%%%%%
\newpage
\input{cap/casosUso/Caso3.tex}

%%%%%%% CASO-4 %%%%%%%%%%%%%%%%
\newpage
\input{cap/casosUso/Caso4.tex}

%%%%%%% CASO-5 %%%%%%%%%%%%%%%%
\newpage
\input{cap/casosUso/Caso5.tex}

%%%%%%% CASO-6 %%%%%%%%%%%%%%%%
\newpage
\input{cap/casosUso/Caso6.tex}

%%%%%%% CASO-7 %%%%%%%%%%%%%%%%
\newpage
\input{cap/casosUso/Caso7.tex}

%%%%%%% CASO-8 %%%%%%%%%%%%%%%%
\newpage
\input{cap/casosUso/Caso8.tex}
